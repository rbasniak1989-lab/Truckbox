...
items=[
    ...
    seg('J1708_TX',7.600,67.000,71.500,67.000,.22,'In2.Cu'),
    seg('J1708_TX',71.500,67.000,71.500,52.000,.22,'In2.Cu'),
    via('J1708_TX',71.500,52.000,.60,.30),
    seg('J1708_TX',71.500,52.000,70.400,51.500,.22),
    seg('J1708_TX',70.400,51.500,69.300,50.405,.22),

    # DE: GPIO12 (U1 pad13) -> separate In2.Cu corridor -> U4 DE.
    seg('J1708_DE',9.250,23.180,7.000,23.180,.22),
    via('J1708_DE',7.000,23.180,.60,.30),
    seg('J1708_DE',7.000,23.180,8.500,25.500,.22,'In2.Cu'),
    seg('J1708_DE',8.500,25.500,8.500,69.000,.22,'In2.Cu'),
    seg('J1708_DE',8.500,69.000,68.000,69.000,.22,'In2.Cu'),
    seg('J1708_DE',68.000,69.000,68.000,49.135,.22,'In2.Cu'),
    via('J1708_DE',68.000,49.135,.60,.30),
    seg('J1708_DE',68.000,49.135,69.300,49.135,.22),

    # R52 hardware pull-down and local ground stitch.
    seg('J1708_DE',7.000,23.180,7.500,26.000,.22),
    seg('GND',6.500,26.000,5.700,26.000,.25),
    via('GND',5.700,26.000,.60,.30),
]
close=s.rfind(')')
if close<0:
