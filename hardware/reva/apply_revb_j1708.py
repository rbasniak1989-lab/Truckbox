...
for a,b,blk in iter_blocks(s,'segment'):
    ...
    if same_pair(p1,p2,(65.5,46.5),(64.5,46.5)):
        drop=True
    if name=='J1708_B' and same_pair(p1,p2,(80.0,48.85),(74.7,47.865)):
        drop=True
    if name=='J1708_A' and same_pair(p1,p2,(80.0,50.15),(74.7,49.135)):
        drop=True
...
load_parts=[
    ...
    fp0603('R55','4.7k J1708_A PULLUP',81.0,52.70,0,'J1708_A_INT','3V3_MAIN'),
    fp0603('R56','4.7k J1708_B PULLDOWN',81.0,46.30,0,'J1708_B_INT','GND'),
    fp0603('C52','2.2nF J1708_A EMI',81.0,54.20,0,'J1708_A_INT','GND'),
    fp0603('C53','2.2nF J1708_B EMI',81.0,44.80,0,'J1708_B_INT','GND'),
]
close=s.rfind(')')
s=s[:close]+'\n'+'\n'.join(load_parts)+'\n'+s[close:]
...
items=[
    ...
    seg('J1708_B_INT',80.000,48.850,80.500,46.300,.22),
    seg('J1708_B_INT',80.500,46.300,80.500,44.800,.22),
    seg('GND',81.500,46.300,82.300,46.300,.25),
    via('GND',82.300,46.300,.60,.30),
    seg('GND',81.500,44.800,82.300,44.800,.25),
    via('GND',82.300,44.800,.60,.30),
    ...
    seg('J1708_A_INT',80.000,50.150,80.500,52.700,.22),
    seg('J1708_A_INT',80.500,52.700,80.500,54.200,.22),
    seg('3V3_MAIN',81.500,52.700,82.300,52.700,.30),
    via('3V3_MAIN',82.300,52.700,.70,.35),
    seg('GND',81.500,54.200,82.300,54.200,.25),
    via('GND',82.300,54.200,.60,.30),
]
close=s.rfind(')')
if close<0:
