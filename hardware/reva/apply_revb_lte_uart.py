...
r=[
    ...
    seg('LTE_1V8',60.0,72.0,60.0,74.0,.20,'In2.Cu'),
    seg('LTE_1V8',60.0,74.0,50.0,74.0,.20,'In2.Cu'),
    seg('LTE_1V8',50.0,74.0,50.0,p6[1],.20,'In2.Cu'),
    via('LTE_1V8',50.0,p6[1],.60,.30),
    seg('LTE_1V8',50.0,p6[1],p6[0],p6[1],.20),
