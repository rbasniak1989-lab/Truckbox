...
p('J4','Mini-Fit/MX 4.2mm 8-way right-angle PCB header','CONN-TH_C4201WR-F-2X4P','C239506','C4201WR-F-2x4P','CJT (Changjiang Connectors)','JLC wave-solder/THT assembly. Mating harness: common 8-way 2x4 Mini-Fit-compatible housing with female contacts.'),
...
- J4: Mini-Fit 8-way / C239506, JLC THT/wave-solder assembly; mates with common 8-way 2x4 Mini-Fit-compatible harness housing.\n- DNP/manual: SW1 until the physical switch is matched.
...
6. Visually inspect polarized/oriented D1/D2/D5/D50/C3/C67/C68, U9/J5, and J4 Mini-Fit orientation in JLC preview.
